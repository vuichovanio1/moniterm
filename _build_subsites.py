...
CITIES = [
    {"slug": "sofia", "name": "София", "blurb": "Монтаж в апартаменти и къщи — с внимание към достъпа и етажната собственост."},
    {"slug": "kostinbrod", "name": "Костинброд", "blurb": "Нашата база — най-бърз оглед и реакция тук и в близките села."},
    {"slug": "slivnitsa", "name": "Сливница", "blurb": "Близо до Костинброд — удобно за оглед и монтаж в същия ден."},
    {"slug": "dragoman", "name": "Драгоман", "blurb": "Къщи и вили — планираме доставката според достъпа на терена."},
    {"slug": "godech", "name": "Годеч", "blurb": "Уговаряме маршрута предварително, за да приключим без излишни посещения."},
    {"slug": "bozhurishte", "name": "Божурище", "blurb": "Близо до София — удобен оглед в работни дни."},
    {"slug": "svoge", "name": "Своге", "blurb": "По Искърското дефиле преценяваме терена още на огледа."},
    {"slug": "elin-pelin", "name": "Елин Пелин", "blurb": "Жилищни и стопански обекти — оразмеряване след оглед."},
    {"slug": "bankya", "name": "Банкя", "blurb": "Жилищни обекти — с внимание към шума и графика на живущите."},
    {"slug": "novi-iskar", "name": "Нови Искър", "blurb": "Северните квартали — монтаж в уговорен ден от Костинброд."},
]
