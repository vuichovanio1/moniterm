    ...
    <div class="container">
      <div class="footer-grid">
        <div>
          ...
          <p class="disclaimer">Мони Терм ЕООД (Костинброд) е самостоятелна фирма и не е свързана с компании със сходно име от други населени места.</p>
        </div>
        <div>
          <h3>Услуги</h3>
          <ul>
    ...
    <section class="section">
      <div class="container content-layout">
        <article class="prose">
          ...
          <p>Костинброд е стратегическа точка за София и София област — бърз достъп до {c["name"]}, Сливница, Драгоман, Годеч и околните села. Не сме фирма със сходно име от друг град.</p>
          <h2>Често задавани въпроси</h2>
          <div class="faq">{faqs_html}</div>
        </article>
        <aside class="side-panel">
