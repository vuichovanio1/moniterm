...
SERVICES = [
    ...
    },
    {
        ...
        "nav": "podovo",
        "name": "Изграждане на подово отопление",
        "h1_hub": "Изграждане на подово отопление",
        "title_hub": "Подово отопление в София област | Мони Терм Костинброд",
        "keyword": "подово отопление",
        "keyword_long": "изграждане на подово отопление",
        "desc_hub": "Проектиране и изграждане на водно подово отопление в София и София област. Изчисление, кръгове, колектори и автоматика от Мони Терм ЕООД.",
        "lead": "Подово отопление с равномерна топлина и по-ниска работна температура — оразмерено за конкретния обект.",
        "detail": "Изграждаме водно подово отопление по помещения, с изчисление на кръговете, правилен подбор на колектор и съгласуване с източника на топлина. Работим както при ново строителство, така и при основни ремонти.",
        "image": "moni53.jpg",
        "gallery": ["moni53.jpg", "moni54.jpg", "moni55.jpg", "moni56.jpg"],
        "bullets": [
        ...
        "process": [
            ("Оглед", "Квадратура, височина на пода и източник на топлина."),
            ("Изчисление", "Оразмеряване на кръгове и разпределение по помещения."),
            ("Монтаж", "Полагане, колектори, връзки и налягане тест."),
            ("Подготовка", "Финален контрол преди замазка и пуск."),
        ],
        "faqs": [
            ("Става ли за апартамент?", "Да, когато конструкцията и височината на пода го позволяват. Проверяваме това на огледа."),
            ("С какъв източник работи?", "Най-често с газов котел или термопомпа, според инсталацията на обекта."),
            ("Работите ли в София област?", "Да — София, Костинброд, Сливница, Драгоман, Годеч, Божурище, Своге, Елин Пелин, Банкя и Нови Искър."),
        ],
    },
    {
        "slug": "vodni-pompi",
...
def hub_headings(s: dict) -> dict[str, str]:
    ...
    variants = {
        ...
        "podovo-otoplenie": {
            "scope": "Какво включва подовото отопление",
            "price": "Как се оферира подово отопление",
            "process": "Оглед, изчисление и монтаж",
            "where": "Къде изграждаме подово отопление",
            "gallery": "Подово отопление на обект",
            "faq": "Въпроси за подово отопление",
        },
        "vodni-pompi": {
